package kr.hs.emirim.w2034.chepter6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStart.setOnClickListener(bntListener);
        btnDone.setOnClickListener(bntListener);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_done:
                    ...
                    textResult.append(time.getCurrentHour() + "시 " + time.getCurrentMinute() + "분 예약종료");
                    break;
            }
        }
    };
